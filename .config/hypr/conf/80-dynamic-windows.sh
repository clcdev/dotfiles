...
# Script from: https://github.com/hyprwm/Hyprland/issues/3835#issuecomment-2491114463
  ...
  case $windowtitle in
    *"(Bitwarden"*"Password Manager) - Bitwarden"*)
      hyprctl --batch \
        ...
        "dispatch resizewindowpixel exact 25% 65%,address:0x$windowaddress;"\
...
#   anyotherevent) handle_otherevent "$data";;
    *) echo "unhandled event: $event" > /dev/null ;;
  esac
}
